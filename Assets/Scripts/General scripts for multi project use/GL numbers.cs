...
namespace MiscFunctions {
    public class GLNumbers {
        ...
        public static void DisplayNumber(int number, Vector3? position = null, Vector3? frontDirection = null, Vector3? upDirection = null, int size = 1) { // implement rotations
            ...
            Vector3 aPosition = (Vector3)position - Vector3.right * number.ToString().Length / 2;
        ...
        private static void Draw2(Vector3 position) {
            for (int i = 0; i < 180; i++) {
                GL.Vertex(position + new Vector3(0, 0, 0.5f) + 0.5f * classSize * new Vector3(Mathf.Cos(i * Mathf.Deg2Rad), 0, Mathf.Sin(i * Mathf.Deg2Rad)));
                GL.Vertex(position + new Vector3(0, 0, 0.5f) + 0.5f * classSize * new Vector3(Mathf.Cos((i + 1) * Mathf.Deg2Rad), 0, Mathf.Sin((1 + i) * Mathf.Deg2Rad)));

                GL.Vertex(position + 0.75f * new Vector3(0, 0, 0.5f) + classSize * 0.5f * new Vector3(0.75f * Mathf.Cos(i * Mathf.Deg2Rad), 0, 0.75f * Mathf.Sin(i * Mathf.Deg2Rad)));
                GL.Vertex(position + 0.75f * new Vector3(0, 0, 0.5f) + classSize * 0.5f * new Vector3(0.75f * Mathf.Cos((i + 1) * Mathf.Deg2Rad), 0, 0.75f * Mathf.Sin((1 + i) * Mathf.Deg2Rad)));
            }

            GL.Vertex(new Vector3(0.5f, 0, 0.5f) - new Vector3(0.1f, 0, 0));
            GL.Vertex(new Vector3(-0.5f, 0, -0.5f) + new Vector3(0, 0, 0.1f));
            GL.Vertex(new Vector3(0.5f, 0, 0.5f) + new Vector3(0.1f, 0, 0));
            GL.Vertex(new Vector3(-0.5f, 0, -0.5f) - new Vector3(0, 0, 0.1f));

            GL.Vertex(new Vector3(-.5f, 0, -1));
            GL.Vertex(new Vector3(.5f, 0, -1));
            GL.Vertex(0.75f * new Vector3(-.5f, 0, -1));
            GL.Vertex(0.75f * new Vector3(.5f, 0, -1));
        }
        private static void Draw3(Vector3 position) {
            for (int i = -90; i < 180; i++) {
                ...
                GL.Vertex(position + new Vector3(0, 0, 0.5f) + 0.5f * classSize * new Vector3(0.75f * Mathf.Cos(i * Mathf.Deg2Rad), 0, 0.75f * Mathf.Sin(i * Mathf.Deg2Rad)));
                GL.Vertex(position + new Vector3(0, 0, 0.5f) + 0.5f * classSize * new Vector3(0.75f * Mathf.Cos((i + 1) * Mathf.Deg2Rad), 0, 0.75f * Mathf.Sin((1 + i) * Mathf.Deg2Rad)));
            }
            for (int i = 0; i < 270; i++) {
                GL.Vertex(position - new Vector3(0, 0, 0.5f) - 0.5f * classSize * new Vector3(Mathf.Cos(i * Mathf.Deg2Rad), 0, Mathf.Sin(i * Mathf.Deg2Rad)));
                GL.Vertex(position - new Vector3(0, 0, 0.5f) - 0.5f * classSize * new Vector3(Mathf.Cos((i + 1) * Mathf.Deg2Rad), 0, Mathf.Sin((1 + i) * Mathf.Deg2Rad)));
        ...
        private static void Draw5(Vector3 position) {
            ...
            GL.Vertex(position + new Vector3(-0.5f, 0, 0));
            GL.Vertex(position + new Vector3(-0.5f, 0, 1));
            GL.Vertex(position + new Vector3(0.75f * -0.5f, 0, 0));
            GL.Vertex(position + new Vector3(0.75f * -0.5f, 0, 1));

            GL.Vertex(position + new Vector3(-0.5f, 0, 1));
            GL.Vertex(position + new Vector3(0.5f, 0, 1));
            GL.Vertex(position + new Vector3(-0.5f, 0, 0.75f * 1));
            GL.Vertex(position + new Vector3(0.5f, 0, 0.75f * 1));
        }
